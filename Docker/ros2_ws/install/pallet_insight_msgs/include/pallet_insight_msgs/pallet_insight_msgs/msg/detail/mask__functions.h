...
#ifndef PALLET_INSIGHT_MSGS__MSG__DETAIL__MASK__FUNCTIONS_H_
#define PALLET_INSIGHT_MSGS__MSG__DETAIL__MASK__FUNCTIONS_H_
 ...
 * calls
 * pallet_insight_msgs__msg__Mask__init().
...
/**
 * It calls
 * pallet_insight_msgs__msg__Mask__fini()
 ...
 * pallet_insight_msgs__msg__Mask__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * pallet_insight_msgs__msg__Mask__Sequence__fini()
 * on the array,
...
#endif  // PALLET_INSIGHT_MSGS__MSG__DETAIL__MASK__FUNCTIONS_H_
