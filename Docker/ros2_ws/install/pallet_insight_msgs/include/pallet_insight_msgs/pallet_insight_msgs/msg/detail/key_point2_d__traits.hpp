...
#ifndef PALLET_INSIGHT_MSGS__MSG__DETAIL__KEY_POINT2_D__TRAITS_HPP_
#define PALLET_INSIGHT_MSGS__MSG__DETAIL__KEY_POINT2_D__TRAITS_HPP_
...
inline void to_yaml(
  const pallet_insight_msgs::msg::KeyPoint2D & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const pallet_insight_msgs::msg::KeyPoint2D & msg)
{
  return pallet_insight_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<pallet_insight_msgs::msg::KeyPoint2D>()
{
  return "pallet_insight_msgs::msg::KeyPoint2D";
}

template<>
inline const char * name<pallet_insight_msgs::msg::KeyPoint2D>()
{
  return "pallet_insight_msgs/msg/KeyPoint2D";
}

template<>
struct has_fixed_size<pallet_insight_msgs::msg::KeyPoint2D>
  : std::integral_constant<bool, has_fixed_size<pallet_insight_msgs::msg::Point2D>::value> {};

template<>
struct has_bounded_size<pallet_insight_msgs::msg::KeyPoint2D>
  : std::integral_constant<bool, has_bounded_size<pallet_insight_msgs::msg::Point2D>::value> {};

template<>
struct is_message<pallet_insight_msgs::msg::KeyPoint2D>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PALLET_INSIGHT_MSGS__MSG__DETAIL__KEY_POINT2_D__TRAITS_HPP_
