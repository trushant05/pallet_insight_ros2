...
{
  new (message_memory) pallet_insight_msgs::msg::BoundingBox3D(_init);
}

void BoundingBox3D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pallet_insight_msgs::msg::BoundingBox3D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox3D_message_member_array[3] = {
  {
    ...
    offsetof(pallet_insight_msgs::msg::BoundingBox3D, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pallet_insight_msgs::msg::BoundingBox3D, size),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pallet_insight_msgs::msg::BoundingBox3D, frame_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox3D_message_members = {
  ...
  3,  // number of fields
  sizeof(pallet_insight_msgs::msg::BoundingBox3D),
...
get_message_type_support_handle<pallet_insight_msgs::msg::BoundingBox3D>()
{
  return &::pallet_insight_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pallet_insight_msgs, msg, BoundingBox3D)() {
  return &::pallet_insight_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox3D_message_type_support_handle;
}
